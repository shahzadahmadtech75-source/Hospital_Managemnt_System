...
// Tab Components
import DashboardTab from '../../components/doctorTabs/DashboardTab';
import AppointmentsTab from '../../components/doctorTabs/AppointmentsTab';
import PatientsTab from '../../components/doctorTabs/PatientsTab';
import PrescriptionsTab from '../../components/doctorTabs/PrescriptionsTab';
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 flex-shrink-0">
          {isSidebarOpen ? (
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg font-semibold text-gray-800">Doctor Portal</span>
            </div>
          ) : (
          ...
          {isSidebarOpen && (
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-gray-800 truncate">
                Dr. {user?.fullName || user?.username || 'Doctor'}
              </p>
