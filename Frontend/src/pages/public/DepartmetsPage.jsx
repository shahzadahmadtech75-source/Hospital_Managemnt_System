...
const handleViewDepartment = (department) => {
  // ✅ Make sure doctors is passed correctly
  setSelectedDepartment({
    ...department,
    doctors: department.doctors || 0
  });
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        {/* Hero Section */}
<section className="relative bg-gradient-to-b from-blue-50 via-white to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 overflow-hidden">
  ...
  <div className="relative flex justify-center">
    <span className="bg-green px-4 flex gap-5">
      ...
      <span className="block w-1.5 h-1.5 rounded-full bg-indigo-800" />
        ...
        <section className="bg-white dark:bg-gray-900 border-b border-slate-100 dark:border-gray-800">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {trustPoints.map((t, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="group bg-white dark:bg-gray-800 rounded-2xl border border-green-400 dark:border-green-700 p-6 transition-all duration-300 hover:border-blue-200 dark:hover:border-blue-800 hover:shadow-xl hover:shadow-blue-100 hover:-translate-y-0.5"
                  >
  ...
  <div className="relative flex justify-center">
    <span className="bg-green px-4 flex gap-5">
      ...
      <span className="block w-1.5 h-1.5 rounded-full bg-indigo-800" />
        ...
        <section className="bg-slate-50 dark:bg-gray-900 border-b border-slate-200 dark:border-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-slate-200 dark:border-gray-700 shadow-sm p-5 flex flex-wrap items-center justify-between gap-6">
              <div className="flex items-center gap-6 flex-wrap">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 flex items-center justify-center flex-shrink-0">
                    <BuildingOfficeIcon className="w-5 h-5 text-blue-600" />
                  </div>
                  <div>
                    <span className="text-xs text-slate-500 dark:text-gray-400">Total Departments</span>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs text-slate-500 dark:text-gray-400">Total Specialists</span>
                    <p className="text-2xl font-bold text-slate-900 dark:text-gray-100 leading-tight">{totalSpecialists}</p>
                  </div>
                </div>
                <div className="w-px h-10 bg-slate-200 dark:bg-gray-700 hidden sm:block"></div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-green-50 dark:bg-green-900/30 border border-green-100 dark:border-green-800 flex items-center justify-center flex-shrink-0">
                    <span className="w-2 h-2 rounded-full bg-green-500" />
                  </div>
                  <div>
                    <span className="text-xs text-slate-500 dark:text-gray-400">Active Departments</span>
                    <p className="text-2xl font-bold text-green-600 leading-tight">{departments.length}</p>
                  </div>
                </div>
              </div>
              <div className="relative w-full sm:w-72">
                <MagnifyingGlassIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-blue-800 dark:text-blue-400" />
                <input
                  type="text"
                  placeholder="Search departments..."
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-10 pr-4 py-2.5 border border-slate-600 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                />
              </div>
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          {currentDepartments.length === 0 ? (
            <div className="text-center py-16 bg-slate-50 dark:bg-gray-800 rounded-2xl border border-slate-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300 font-medium">No departments found</p>
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {currentDepartments.map((department) => (
                  <div
                    key={department._id}
                    className="group bg-white dark:bg-gray-800 rounded-2xl border border-slate-200 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-800 hover:shadow-xl hover:shadow-blue-100 hover:-translate-y-0.5 transition-all duration-300 overflow-hidden"
                  >
                    {/* Department Image */}
                    <div className="h-48 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 overflow-hidden relative">
                      {department.image ? (
                        <img
                    ...
                    <div className="p-5 border-t border-slate-100 dark:border-gray-700">
                      ...
                      <p className="text-sm text-slate-500 dark:text-gray-400 leading-relaxed min-h-[48px]">
                        {getTruncatedDescription(department.description, 100)}
                      </p>

                      <div className="flex items-center gap-4 mt-3 pt-3 border-t border-slate-100 dark:border-gray-700 text-xs text-slate-500 dark:text-gray-400">
                        <span className="flex items-center gap-1">
                          <UserGroupIcon className="w-3.5 h-3.5 text-blue-400" />
                          {department.doctors || 0} Doctors
                        </span>
                      ...
                      <button
                        ...
                        className="w-full mt-4 px-4 py-2.5 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-600 text-blue-700 dark:text-blue-400 hover:text-white font-medium rounded-lg transition-colors border border-blue-100 dark:border-blue-800 hover:border-blue-600 flex items-center justify-center gap-2 group/btn"
                      >
              ...
              {/* Pagination */}
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-2 mt-10 pt-8 border-t border-slate-100 dark:border-gray-800">
                  <button
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid sm:grid-cols-3 gap-8">
              {howItWorks.map((step, i) => {
                ...
                return (
                  <div key={i} className="relative rounded-lg border-green-300 dark:border-green-700 border-2 rounded p-4">
                    <div className="flex items-center gap-3 mb-4 ">
                      <div className="w-11 h-11 rounded-xl bg-blue-600 flex items-center justify-center flex-shrink-0">
                        <Icon className="w-5 h-5 text-white" />
                      </div>
                      <span className="text-3xl font-bold text-blue-100 dark:text-blue-900">{step.step}</span>
                    </div>
                    <h3 className="font-semibold text-slate-900 dark:text-gray-100 mb-1.5">{step.title}</h3>
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-6 pb-6 border-b border-slate-100 dark:border-gray-700">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-xl bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 flex items-center justify-center overflow-hidden flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-gray-400 flex items-center gap-1 mt-0.5">
                      <UserGroupIcon className="w-3.5 h-3.5 text-blue-400" />
                      {selectedDepartment.doctors || 0} Doctors
                    </p>
                  </div>
                </div>
                <button
                  ...
                  className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 rounded-lg hover:bg-slate-100 dark:hover:bg-gray-700 transition-colors flex-shrink-0"
                >
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-100 dark:border-blue-800">
                  <p className="text-sm font-medium text-blue-700 dark:text-blue-400 mb-1">About this Department</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-slate-50 dark:bg-gray-700 rounded-xl p-4 border border-slate-200 dark:border-gray-600">
                    <p className="text-xs text-slate-500 dark:text-gray-400">Department Name</p>
                    <p className="font-medium text-slate-800 dark:text-gray-100">{selectedDepartment.name}</p>
                  </div>
                  <div className="bg-slate-50 dark:bg-gray-700 rounded-xl p-4 border border-slate-200 dark:border-gray-600">
                    <p className="text-xs text-slate-500 dark:text-gray-400">Doctor Count</p>
                    <p className="font-medium text-slate-800 dark:text-gray-100">{selectedDepartment.doctors || 0}</p>
                  </div>
                  {selectedDepartment.createdAt && (
                    <div className="bg-slate-50 dark:bg-gray-700 rounded-xl p-4 border border-slate-200 dark:border-gray-600 sm:col-span-2">
                      <p className="text-xs text-slate-500 dark:text-gray-400">Established</p>
                      <p className="font-medium text-slate-800 dark:text-gray-100">{formatDate(selectedDepartment.createdAt)}</p>
                    </div>
                  )}
                </div>

                <div className="bg-slate-50 dark:bg-gray-700 rounded-xl p-4 border border-slate-200 dark:border-gray-600 flex items-start gap-2">
                  <IdentificationIcon className="w-4 h-4 text-slate-400 dark:text-gray-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="text-xs text-slate-500 dark:text-gray-400">Department ID</p>
                    <p className="text-sm text-slate-600 dark:text-gray-300 font-mono">{selectedDepartment._id}</p>
                  </div>
                </div>
              </div>
