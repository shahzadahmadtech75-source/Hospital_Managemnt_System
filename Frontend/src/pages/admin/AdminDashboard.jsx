...
import StaffTab from '../../components/adminTabs/StaffTab';
import PatientsTab from '../../components/adminTabs/PatientsTab';
import DepartmentsTab from '../../components/adminTabs/DepartmentsTab';
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (storedUser) {
        ...
        const hasRequiredFields = userData.email && userData.role === 'admin';
