...
// Tab Components
import DashboardTab from '../../components/accountantTabs/DashboardTab';
import InvoicesTab from '../../components/accountantTabs/InvoicesTab';
          ...
          {isSidebarOpen && (
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-gray-800 truncate">
                {user?.fullName || user?.username || 'Accountant'}
              </p>
