...
// Tab Components
import DashboardTab from '../../components/nurseTabs/DashboardTab';
import PatientsTab from '../../components/nurseTabs/PatientsTab';
import BedsTab from '../../components/nurseTabs/BedsTab';
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 flex-shrink-0">
          {isSidebarOpen ? (
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg font-semibold text-gray-800">Nurse Portal</span>
            </div>
          ) : (
          ...
          {isSidebarOpen && (
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-gray-800 truncate">
                {user?.fullName || user?.username || 'Nurse'}
              </p>
