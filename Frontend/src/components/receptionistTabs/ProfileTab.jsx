...
const ProfileTab = ({ setIsProfileComplete }) => {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        const isComplete = data.isProfileCompleted || false;
  ...
  try {
    ...
    const response = await axiosInstance.patch('/receptionist/profile', formDataToSend, {
      headers: {
    ...
    if (response.data.success) {
      ...
      if (storedUser) {
        ...
        const updatedUser = { 
          ...
          // ✅ Get profileImage from response
      ...
      // ✅ Force refresh the page to update header
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.patch('/receptionist/change-password', passwordData);
      if (response.data.success) {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-semibold text-gray-800">Receptionist Profile</h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  placeholder="123 Hospital St, City, State"
                />
              </div>
            </div>
