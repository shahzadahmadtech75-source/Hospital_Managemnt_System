...
const DoctorsTab = () => {
  ...
  const fetchDoctors = async () => {
    setLoading(true);
    try {
      const response = await axiosInstance.get('/accountant/doctors');
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">View all doctors and their details</p>
      </div>
      ...
      <div className="relative mb-6">
        ...
        <input
          type="text"
          placeholder="Search doctors by name, department, specialization, email, or phone..."
          value={searchTerm}
      ...
      {filteredDoctors.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <p className="text-gray-500 text-sm mt-1">
            {searchTerm ? 'Try adjusting your search' : 'No doctors registered yet'}
          </p>
        </div>
      ) : (
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-xs text-gray-400 border-t border-gray-200 pt-4">
                  <p>Doctor ID: {selectedDoctor._id}</p>
                  <p>Username: {selectedDoctor.username || 'N/A'}</p>
                  <p>Status: {selectedDoctor.isActive !== undefined ? (selectedDoctor.isActive ? 'Active' : 'Inactive') : 'N/A'}</p>
                </div>
              </div>
