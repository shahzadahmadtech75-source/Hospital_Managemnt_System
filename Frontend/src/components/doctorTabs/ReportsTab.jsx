...
const ReportsTab = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get('/doctor/reports', { params });
  ...
  const handleCreateReport = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post('/doctor/reports', formDataToSend, {
        headers: {
  ...
  const handleUpdateReport = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.patch(`/doctor/reports/${selectedReport._id}`, formDataToSend, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
  ...
  const handleDeleteReport = async (reportId) => {
    ...
    try {
      const response = await axiosInstance.delete(`/doctor/reports/${reportId}`);
      if (response.data.success) {
    ...
    <div className="p-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Create and manage patient reports</p>
        </div>
        <button
      ...
      {reports.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <p className="text-gray-500 text-sm mt-1">
            {filter === 'all' ? 'Create your first report' : `No ${filter} reports found`}
          </p>
        </div>
      ) : (
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <p className="font-medium text-gray-800">Dr. {selectedReport.doctor?.fullName || 'Unknown'}</p>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  onClick={() => {
                    setShowCreateModal(false);
                    setFormData({ patientId: '', type: '', description: '', reportDate: '' });
                    setSelectedFile(null);
                  }}
                  className="p-1.5 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 transition-colors"
                >
