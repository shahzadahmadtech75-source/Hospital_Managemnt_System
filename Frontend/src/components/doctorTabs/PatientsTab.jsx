    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">
          View all patients who have appointments with you
        </p>
      </div>
      ...
      {filteredPatients.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <p className="text-gray-500 text-sm mt-1">
            {searchTerm ? 'Try adjusting your search' : 'Patients will appear here after appointments'}
          </p>
        </div>
      ) : (
          ...
          {filteredPatients.map((patient) => (
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-gray-800 text-base truncate">
                    {patient.fullName || patient.user?.fullName || 'Unknown'}
                  </h3>
                  {patient.phone && (
              ...
              <div className="mt-3 pt-3 border-t border-gray-100 flex flex-wrap gap-2 text-xs text-gray-500">
                ...
                {patient.address && (
                  <span className="truncate max-w-full">• {patient.address}</span>
                )}
              </div>

              <button
                onClick={() => handleViewPatient(patient)}
                className="w-full mt-3 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 text-sm font-medium rounded-md transition-colors border border-blue-200 flex items-center justify-center gap-2"
              >
