...
const ProfileTab = ({ setIsProfileComplete }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.patch('/nurse/profile', formDataToSend, {
        headers: {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.patch('/nurse/change-password', passwordData);
      if (response.data.success) {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-semibold text-gray-800">Nurse Profile</h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  rows="3"
                  className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                  placeholder="Brief description about yourself and your nursing experience"
                />
              </div>
            </div>
